...
<script>
    ...
    Phx.vista.FormProveedorEva  = Ext.extend(Phx.gridInterfaz, {
            ...
            constructor: function (config) {
				...
				Phx.vista.FormProveedorEva.superclass.constructor.call(this, config);
				...
				this.store.baseParams = {id_gestion: v_maestro.data.id_gestion,tipo: v_maestro.data.tipo,id_curso: v_maestro.data.id_curso, id_proveedor: v_maestro.data.id_proveedor};//agregado para filtro y enviar parametro
            ...
            title: 'Cuestionario',
            ActSave: '../../sis_formacion/control/Curso/insertarCuestionarioProveedor',
            ActList: '../../sis_formacion/control/Curso/listarPreguntasProveedor',
	        ...
	        onButtonEdit: function () {
	            Phx.vista.FormProveedorEva.superclass.onButtonEdit.call(this);
	        },
            loadValoresIniciales: function () {
                Phx.vista.FormProveedorEva.superclass.loadValoresIniciales.call(this);
